...
appstream:
  ...
  summary: An application for customizing sound effects when using the PipeWire server.
  metadata_license:
    name: GNU GPLv3
...
EasyEffects is an application for customizing sound effects when using the PipeWire server. There is both the possibility of manual configuration and import/export of ready-made presets.
